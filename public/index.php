...
?>
<!DOCTYPE html>
<!-- public/index.php 💬 PLANTILLA DINÁMICA FILITOUR -->
<html lang="es">
<head>
<meta charset="UTF-8" />
...
<div class="admin-bar">
<div class="admin-bar-title">💬�️ MODO EDICI✨N ACTIVADO</div>
...
<a data-page="map" class="nav-map active" data-txt="nav_map">💬�️ MAPA</a>
...
<a data-page="reviews" data-txt="nav_rev">RESE✨AS</a>
...
<button class="gsb-close" id="gsb-close" aria-label="Cerrar búsqueda">💬</button>
</div>
<!-- ✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨� REDES ✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨� -->
...
<button id="toggle-ui-btn" title="Ocultar interfaz">💬�️</button>
...
<!-- ✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨� PÁGINA: PAQUETES ✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨� -->
<!-- 💬 Sin input grande de búsqueda + carrusel móvil con flechas y dots -->
...
<div class="tf-swipe-hint center">💬? Desliza o usa ✨� ✨� para ver más playas</div>
</div>
</div></div>
<!-- ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨  P� GINA: TRASLADOS (slides estilo PowerPoint) ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨  -->
...
<button class="tf-cta-mini pulse" id="book-transfer-btn">💬� HAZ TU TRASLADO 💬</button>
<small>💬� Cotización en minutos por WhatsApp</small>
<span class="tf-swipe-hint">💬? Desliza o usa ✨� ✨� para ver más rutas</span>
</aside>
</div>
</div>
...
<button id="rev-submit" class="btn-primary">PUBLICAR RESE✨A 💬</button>
</div>
</div>
...
<button class="modal-close" data-close="media-modal">💬</button>
...
<div class="modal-box glass-panel">
<button class="modal-close" data-close="video-modal">💬</button>
<div class="video-stage" id="video-modal-container"></div>
</div>
</div>
<!-- ✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨� LIGHTBOX ✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨� -->
<div id="lightbox"><img id="lightbox-img" src="" alt=""></div>
<!-- ✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨� MODAL RESERVA (paquetes / playas) 💬 imagen premium ✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨�✨� -->
<div class="modal-overlay" id="booking-modal">
<div class="modal-box glass-panel">
<button class="modal-close" data-close="booking-modal">💬</button>
<div class="modal-scroll-area">
...
<div class="modal-box glass-panel">
<button class="modal-close" data-close="transfer-modal">💬</button>
<div class="modal-scroll-area">
...
<button class="btn-ghost trip-type-btn active" data-trip="one_way">💬 Solo Ida</button>
...
<button class="modal-close" data-close="admin-modal" onclick="document.getElementById('admin-modal').classList.remove('active');">💬</button>
...
<div class="form-row" id="row-pin-size"><label>TAMA✨O PIN (px)</label><input id="add-pin-size" type="number" class="glass-input" value="48"></div>
...
<div class="form-row"><label>PRECIO NI✨O ($)</label><input id="add-price-child" type="number" class="glass-input" value="28"></div>
...
<div class="form-row"><label>DURACI✨N</label><input id="add-duration" class="glass-input" placeholder="Ej: 8h"></div>
...
<div class="form-row full"><label>💬� FOTO (solo URL pública)</label><input id="cms-block-img" class="glass-input" placeholder="https://..."></div>
<div class="form-row"><label>💬� POSICI✨N DE LA IMAGEN</label>
...
<div class="form-row"><label>💬� AJUSTE DE LA IMAGEN</label>
...
<div class="form-row"><label>UBICACI✨N</label><input id="beach-edit-zone" class="glass-input"></div>
...
<div class="form-row"><label>UBICACI✨N</label><input id="beach-new-zone" class="glass-input" placeholder="Ej: Pedasí, Los Santos"></div>
