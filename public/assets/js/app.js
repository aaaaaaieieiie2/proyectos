...
function renderServices() {
 ...
 '<img src="' + esc(s.img) + '" class="transfer-img" data-service-img="' + i + '" style="object-position:' + esc(s.imgPosition || 'center') + ';object-fit:' + esc(s.imgFit || 'cover') + ';" onerror="this.style.display=\'none\'"><div class="transfer-img-fallback">🗺️/div></div>' +
...
// ── 🗺️Render: carrusel de traslados (slides + dots + banner anclado) ───────
function renderTransferDestinations() {
 ...
 '<div class="tf-slide-visual"><div class="tf-emoji-bg">' + (tf.emoji || '🗺️) + '</div></div>' +
